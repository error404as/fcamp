...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"1":"view"}[chunkId]||chunkId) + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newsViewer = __webpack_require__(6);

	var _newsViewer2 = _interopRequireDefault(_newsViewer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	document.addEventListener("DOMContentLoaded", function () {

		var sources = __webpack_require__(13);
		new _newsViewer2.default(sources);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newsProvider = __webpack_require__(7);
	...
	var noImg = __webpack_require__(8);
	...
	var Viewer = function () {
		...
		_createClass(Viewer, [{
			...
			value: function renderNav() {
				this.nav.innerHTML = this.sources.map(function (itm) {
			...
			value: function getSource() {
				...
				if (window.location.hash) {
					var _ret = function () {
						...
						return {
							v: _this3.sources.filter(function (itm) {
								return itm.name === hash;
							}).length ? hash : null
						};
					}();
			...
			value: function markNav(id) {
				...
				var active = this.nav.querySelector('[href="#' + id + '"]');
				if (current) {
			...
			key: 'entriesStyling',
			value: function entriesStyling(callback) {
